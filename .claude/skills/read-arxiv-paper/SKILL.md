...
As for the summary itself, remember that you're processing this paper within the context of the retrofitting recurrent transformers from pretrained models repository, so most often we we will be interested in how to apply the paper and its lessons to the project. Therefore, you should feel free to "remind yourself" of the related code by reading the relevant parts, and then explicitly make the connection of how this paper might relate to retrofitting recurrent/looped transformers or what are things we might be inspired about or try.