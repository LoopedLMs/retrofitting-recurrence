...
parser.add_argument("--dataset_path", type=str, required=True, help="Path to the dataset directory or file to load.")
parser.add_argument("--dataset_save_dir", type=str, required=True, help="Path to the dataset directory or file to save.")
parser.parse_args()
